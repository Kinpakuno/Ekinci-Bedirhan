...
public class Enregistrement extends TimerTask {
    ...
    public Enregistrement(HttpClient httpClient, ImageView vue, ImageView vue2, ImageView vue3, ImageView vue4) {
    ...
    public void run() {
        Platform.runLater(new Runnable() {
            public void run() {
                ...
                try {
                    java.net.http.HttpResponse<InputStream> reponse = httpClient.send(requete, java.net.http.HttpResponse.BodyHandlers.ofInputStream());
                ...
                HttpRequest requete2 = HttpRequest.newBuilder()
                        .GET()
                        .uri(URI.create("http://10.197.0.3/dms?nowprofileid="))
                        .build();
                InputStream inputStream2 = null;
                // envoie d'une requête, affichage de la réponse à l'écran
                try {
                    java.net.http.HttpResponse<InputStream> reponse = httpClient.send(requete2, java.net.http.HttpResponse.BodyHandlers.ofInputStream());
                ...
                // envoie d'une requête, affichage de la réponse à l'écran
                try {
                    java.net.http.HttpResponse<InputStream> reponse = httpClient.send(requete3, java.net.http.HttpResponse.BodyHandlers.ofInputStream());
                ...
                // envoie d'une requête, affichage de la réponse à l'écran
                try {
                    java.net.http.HttpResponse<InputStream> reponse = httpClient.send(requete4, HttpResponse.BodyHandlers.ofInputStream());
